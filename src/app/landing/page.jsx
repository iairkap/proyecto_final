        ...
        <div className="principal">
          ...
          <div className="title-description-text">
            ...
            <p>
              ...
              eget, consectetur suscipit magna. Curabitur et quam eu ante
              gravida ultricies.{" "}
            </p>
          </div>
        ...
        <div className="project">
          ...
          <div className="project-text">
            ...
            <p>
              ...
              felis et urna mollis tincidunt. Proin felis sem, aliquet eu turpis
              eget, consectetur suscipit magna. Curabitur et quam eu ante
              gravida ultricies. Etiam pharetra pretium sem, sit amet porta
              metus mollis at. Donec eget purus varius, imperdiet diam sed,
              porttitor metus. Cras luctus sit amet nunc ut malesuada. Orci
              varius natoque penatibus et magnis dis parturient montes, nascetur
              ridiculus mus. Vivamus maximus ornare mi nec semper. Phasellus et
              sapien odio. Pellentesque laoreet tortor iaculis nibh aliquam
              tempor. Vivamus vehicula iaculis velit a fermentum.
            </p>
            <div>
